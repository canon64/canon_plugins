...
namespace MainGameBlankMapAdd
{
    public sealed partial class Plugin
    {
        ...
        private void OnGUI()
        {
            ...
            float toggleGroupW = helpToggleW + hipUiToggleW + clubUiToggleW + afterimageToggleW + dollModeToggleW + poseToggleW + scenarioAutoToggleW + scenarioManualButtonW + cameraToggleW + toggleGap * 8f;
