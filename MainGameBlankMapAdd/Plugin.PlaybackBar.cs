    ...
    public sealed partial class Plugin
    {
        ...
        private void OnGUI()
        {
            ...
            float controlsTotalH = showRoomControls
                ? (layoutSectionH + controlsGapY + integrationSectionH + controlsGapY + overlaySectionH)
                : 0f;
            ...
            float toggleGroupW = helpToggleW + hipUiToggleW + clubUiToggleW + afterimageToggleW + dollModeToggleW + poseToggleW + scenarioAutoToggleW + scenarioManualButtonW + cameraToggleW + subCamToggleW + autoHVoiceToggleW + toggleGap * 10f;
