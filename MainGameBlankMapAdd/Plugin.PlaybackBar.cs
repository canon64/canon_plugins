...
namespace MainGameBlankMapAdd
{
    public sealed partial class Plugin
    {
        ...
        private void OnGUI()
        {
            ...
            float toggleGroupW = helpToggleW + hipUiToggleW + clubUiToggleW + afterimageToggleW + dollModeToggleW + poseToggleW + scenarioAutoToggleW + scenarioManualButtonW + cameraToggleW + autoHVoiceToggleW + toggleGap * 9f;
            ...
            float autoHVoiceToggleX = cameraToggleX + cameraToggleW + toggleGap;
