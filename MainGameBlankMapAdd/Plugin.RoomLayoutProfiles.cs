    ...
    public sealed partial class Plugin
    {
        ...
        private void SaveFolderBeatSyncProfileFromBar()
        {
            ...
            LogInfo(
                ...
                $"enabled=system bpm={profile.BeatBpm} autoMotion={profile.BeatAutoMotionSwitch} " +
            ...
            string videoPathOverride = null)
        {
            ...
            if (hasVideo && videoProfile.HasBeatSync)
            {
                ...
                if (TryApplyBeatSyncSnapshot(snap, $"profile-video:{trigger}", applyEnabled: false, preferSavedSongBpm: true))
                {
            ...
            else if (hasFolder && folderProfile.HasBeatSync)
            {
                ...
                if (TryApplyBeatSyncSnapshot(snap, $"profile-folder:{trigger}", applyEnabled: false, preferSavedSongBpm: true))
                {
            ...
            else if (FolderBaselineProfile != null && FolderBaselineProfile.HasBeatSync)
            {
                ...
                if (TryApplyBeatSyncSnapshot(snap, $"profile-folder-baseline:{trigger}", applyEnabled: false, preferSavedSongBpm: true))
                {
