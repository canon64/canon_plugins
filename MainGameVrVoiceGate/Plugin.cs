...
namespace MainGameVrVoiceGate
{
    ...
    public sealed class Plugin : BaseUnityPlugin
    {
        ...
        private void Update()
        {
            ...
            bool pressed = Settings != null && Settings.Enabled && IsRightBPressed();
        ...
        private bool IsRightBPressed()
        {
            try
            {
                ...
                return right.Input.GetPress(EVRButtonId.k_EButton_Axis0);
            }
            catch (Exception ex)
            {
                LogInputError("[input] right B read failed: " + ex.Message);
                return false;
            }
        }
