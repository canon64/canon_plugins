param(
    ...
    [string]$ProductionRepoUrl = 'https://github.com/canon64/MainGameBlankMapAdd.git',
    [string]$GitHubRepo = 'canon64/MainGameBlankMapAdd',
    [string]$PluginName = 'MainGameBlankMapAdd',
...
$baseScriptPath = Join-Path $PSScriptRoot 'New-VideomapDllZip.ps1'
...
Write-Output ('Deploy profile: videomap {0}' -f $DeployProfile)
