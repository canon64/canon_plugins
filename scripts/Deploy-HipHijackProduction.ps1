param(
    ...
    [string]$ProductionRepoUrl = 'https://github.com/canon64/MainGirlHipHijack.git',
    [string]$GitHubRepo = 'canon64/MainGirlHipHijack',
    [string]$PluginName = 'MainGirlHipHijack',
    ...
    [string]$ZipName = '',
    [string]$ReleaseAssetName = 'canon_plugins_bundle.zip',
...
$baseScriptPath = Join-Path $PSScriptRoot 'New-HipHijackDllZip.ps1'
...
Write-Output ('Deploy profile: hiphijack {0}' -f $DeployProfile)
