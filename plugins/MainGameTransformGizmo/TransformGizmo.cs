...
namespace MainGameTransformGizmo
{
    ...
    public sealed class TransformGizmo : MonoBehaviour
    {
        ...
        public GizmoAxisSpace AxisSpace { get; private set; } = GizmoAxisSpace.Local;
        ...
        private const float RotateLineWidth = 0.02f;
        ...
        {
            var mat = new Material(Shader.Find("Unlit/Texture") ?? Shader.Find("Standard"))
            {
                mainTexture = tex
            };
            return mat;
