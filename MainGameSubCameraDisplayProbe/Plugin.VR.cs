...
namespace MainGameSubCameraDisplayProbe
{
    public sealed partial class Plugin
    {
        ...
        private static readonly Vector3 CameraAttachedPreviewLocalPosition = new Vector3(0f, 0.14f, -0.18f);
        ...
        private void UpdateHandPreview(Transform hand)
        {
            ...
            _handPreviewObject.transform.localPosition = CameraAttachedPreviewLocalPosition;
