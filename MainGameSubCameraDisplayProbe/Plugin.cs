...
namespace MainGameSubCameraDisplayProbe
{
    ...
    public sealed partial class Plugin : BaseUnityPlugin
    {
        ...
        private void Update()
        {
            ...
            bool cameraDragging = _cameraGizmo != null && _cameraGizmo.IsDragging;
            if (!cameraDragging)
                UpdateBoneFollow();

            if (_subCamera != null && !(_cameraGizmo != null && _cameraGizmo.IsDragging))
                ApplyCameraSettings();
