...
namespace MainGameSubCameraDisplayProbe
{
    public sealed partial class Plugin
    {
        private void EnsureProbe()
        {
            ...
            _displayBackObject = GameObject.CreatePrimitive(PrimitiveType.Quad);
            _displayBackObject.name = "DisplayQuadBack";
            _displayBackObject.transform.SetParent(_displayAnchorObject.transform, false);
            _displayBackObject.transform.localPosition = new Vector3(0f, 0f, 0.001f);
            _displayBackObject.transform.localRotation = Quaternion.Euler(0f, 180f, 0f);
            _displayBackMaterial = CreateDisplayMaterial(backFace: true);
            _displayBackMaterial.mainTexture = _renderTexture;
            _displayBackMaterial.mainTextureScale = new Vector2(-1f, 1f);
            _displayBackMaterial.mainTextureOffset = new Vector2(1f, 0f);
            _displayBackObject.GetComponent<Renderer>().material = _displayBackMaterial;
        ...
        private void ApplyDisplaySettings()
        {
            ...
            if (_displayBackObject != null)
                _displayBackObject.transform.localScale = new Vector3(_settings.DisplayWidth, _settings.DisplayHeight, 1f);
        ...
        private void DestroyProbe()
        {
            ...
            if (_displayBackMaterial != null)
            {
                Destroy(_displayBackMaterial);
                _displayBackMaterial = null;
            }
        ...
        private void ApplyDisplayLayer()
        {
            ...
            SetLayerRecursive(_displayBackObject, layer);
            SyncDisplayOverlayCamera();
        }
