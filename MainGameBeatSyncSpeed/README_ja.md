...
## 導入
- `MainGameBeatSyncSpeed.dll` を `BepInEx/plugins/canon_plugins/MainGameBeatSyncSpeed/` に配置します。
...
- ログ: `BepInEx/plugins/canon_plugins/MainGameBeatSyncSpeed/MainGameBeatSyncSpeed.log`
